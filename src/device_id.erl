...
%% The device ID is used as the unique identifier for each server.
%% The device ID is consisted of UUID and Random Element. It is unique
%% in the whole system.
%% 
...
uuid1_time() ->
    ...
    Timestamp = ?nanosecond_intervals_offset + ?nanosecond_intervals_factor * UnixEpoch,
	<<Timestamp:60>>.
